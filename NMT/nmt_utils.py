...
def load_date():
    ...
    try:
        human_readable = format_date(dt, format=random.choice(FORMATS),  locale='az') # locale=random.choice(LOCALES))
...
def load_dataset(m):
    ...
    with open(r".\datasets\written_data", "rb") as fp:   # Unpickling
        imade = pickle.load(fp)
...
EXAMPLES = ['3 May 1979', '5 Apr 09', '2016 fevralin 10 u', 'bazar 99 cu il avqustun 25 i']
